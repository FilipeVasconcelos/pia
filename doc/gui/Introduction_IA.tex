...
\section{Mise à jour des matrices de poids - Rétropropagation}
\label{sec-3}
...
\subsection{Le OU exclusif}
\label{sec-4-3}

$W^{1}=\begin{pmatrix}0\\0\end{pmatrix}$

\subsection{La fonction d'activation: sigmoïde}
\label{sec-4-4}
